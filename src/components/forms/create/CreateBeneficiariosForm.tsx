    ...
    <div className="flex flex-col gap-6 w-full max-h-[80vh] overflow-y-auto pr-2 custom-scrollbar text-left">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
        ...
        <Input 
          ...
          {...register("cpf", { 
            ...
            pattern: { value: /^\d{11}$|^\d{3}\.\d{3}\.\d{3}-\d{2}$/, message: "Formato de CPF inválido" }
          })} 
        />
      ...
      <div className="border-t pt-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
          ...
          />
          <Input label="Número" error={errors.numero?.message} {...register("numero", { required: "Obrigatório" })} />
          <Input label="Logradouro" error={errors.logradouro?.message} {...register("logradouro", { required: "Obrigatório" })} />
          <Input label="Cidade" error={errors.cidade?.message} {...register("cidade", { required: "Obrigatório" })} />
          <Input label="Estado" error={errors.estado?.message} {...register("estado", { required: "Obrigatório" })} />
        </div>
      </div>
