...
export const useImpactStats = () => {
  return React.useMemo(() => {
    ...
    // Lógica do Ranking de Estados (Isolada aqui!)
    const statsPorEstado = Object.entries(
    ...
    return { total: beneficiariosData.length, qtdTdb, qtdAdb, totalHoras, statsPorEstado };
  }, [beneficiariosData]);
};